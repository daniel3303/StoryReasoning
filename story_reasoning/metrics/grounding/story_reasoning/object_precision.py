...
class ObjectPrecision(StoryReasoningGroundingMetric):
    """
    Precision metric specifically for non-character object grounding in story reasoning.
    ...
    def _compute_score(
        ...
        """
        Compute mean precision for object detections across all samples.
        ...
        Returns:
            float: Mean object precision score across all samples
        """
        scores = []
        ...
        for story_id in candidate_detections:
            ...
            if not cand_dets:
                scores.append(1.0)  # If no object mentions, precision is perfect
                continue
